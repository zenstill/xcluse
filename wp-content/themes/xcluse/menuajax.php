          ...
          <div class="section-header--left">
			  ...
			  $top_parent = get_term($parent->parent, 'product_cat' );
                          ...
                          <?php if(!empty($top_parent) && isset($top_parent)){?>
                           <a title="Grid view" class="collection-view--active bred_cum"  data-id="<?php echo $top_parent->term_id;?>">
			  <?php echo $top_parent->name;?> &nbsp;<span> &gt;</span>&nbsp;&nbsp;</a>
						  <?php } ?>
                          <?php if(!empty($parent) && isset($parent)){?>
                           <a title="Grid view" class="collection-view--active bred_cum" data-id="<?php echo $parent->term_id;?>">
