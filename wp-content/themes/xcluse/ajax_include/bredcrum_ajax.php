<?php 
add_action( 'wp_ajax_nopriv_bredcrum_ajax', 'bredcrum_ajax' );  
add_action( 'wp_ajax_bredcrum_ajax', 'bredcrum_ajax' ); 
function bredcrum_ajax(){
          ...
          <div class="section-header--left">
			  ...
			  $top_parent = get_term($parent->parent, 'product_cat' );
                          ...
                          <?php if(!empty($top_parent) && isset($top_parent)){?>
                           <a class="collection-view--active bred_cum"  data-id="<?php echo $top_parent->term_id;?>">
			  <?php echo $top_parent->name;?> &nbsp;<span> &gt;</span>&nbsp;&nbsp;</a>
						  <?php } ?>
                          <?php if(!empty($parent) && isset($parent)){?>
                           <a class="collection-view--active bred_cum" data-id="<?php echo $parent->term_id;?>">
