    ...
    class YITH_WCAN_Reset_Navigation_Widget extends WP_Widget {
        ...
        function widget( $args, $instance ) {
            ...
            if ( count( $_chosen_attributes ) > 0 || $min_price > 0 || $max_price > 0 ) {
				...
				echo "<div class='yith-wcan'><a class='yith-wcan-reset-navigation button' href='".HOME."shop'>" . __( $label, 'yit' ) . "</a></div>";
                echo $after_widget;
                echo ob_get_clean();
            }
            else {
                ob_end_clean();
                echo substr( $before_widget, 0, strlen( $before_widget ) - 1 ) . '' . $after_widget;
            }
        }
