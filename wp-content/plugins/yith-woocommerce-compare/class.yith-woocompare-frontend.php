    ...
    class YITH_Woocompare_Frontend {
        ...
        public function enqueue_scripts() {
            ...
            wp_localize_script( 'yith-woocompare-main', 'yith_woocompare', array(
                ...
                'added_label' => __( '<i class="added_comp" title="Added to Compare"></i>', 'yit' ),
        ...
        public function add_compare_link( $product_id = false, $args = array() ) {
            ...
            printf( '<a href="%s" class="%s" data-product_id="%d" title="Add to Compare">%s</a>', $this->add_product_url( $product_id ), 'compare', $product_id, '<i class="level_comp"></i>' );
