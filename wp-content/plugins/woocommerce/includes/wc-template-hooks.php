 ...
 */
add_action( 'woocommerce_bredcrumbs', 'woocommerce_breadcrumb', 20, 0 );
 ...
 */
add_action( 'woocommerce_before_shop_loop_count', 'woocommerce_result_count', 20 );
...
add_action( 'woocommerce_before_shop_loop_item_thumbnail', 'woocommerce_template_loop_product_thumbnail', 10 );
